...
- [663](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/663) Sorting Slides (Bipartite graph check for Max Cardinality Bipartite Matching MCBM using Edmonds Karp max flow: we need to detect edges that when removed make the MCBM decrease)
...
- [10054](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/10054) The Necklace (Simple eulerian path print using std::list<int>)
...
- [10349](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/10349) Antenna Placement (Bipartite MCBM, use property that places on odd/even diagonals are in different bipartitions)
...
- [10805](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/10805) Cockroach Escape Networks (Very interesting problem: Min Diameter Spanning Tree, given a graph find the spanning tree with the smallest diameter. Done by trying to build a spanning tree using as root either a node or a vertex. The best root (minimizing the max distance to any vertex) gives the diameter of the spanning tree. Notice that the hard part is understanding that also an edge can be a root).
...
- [11159](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/11159) Factors and Multiples (Bipartite graph: MIS max independent set and MCBM max cardinality bipartite matching using augmenting path solution)
...
- [11695](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/11695) Flight Planning (Given a tree, remove a single edge and add a single edge such that the diameter is minimized. Strategy: split the tree in two by removing iteratively every edge. Compute best roots of the two CCs. Join the two roots together. Keep the best)
...
- [12186](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/12186) Another Crisis (Very simple, take advantage of graph being a tree in order to compute recursive cost property)
...
- [12347](https://github.com/steber97/competitive-programming/tree/main/uva/chapter_4_graphs/12347) Binary Search Tree (simple post-order traversal reconstruction given a pre-order traversal of a binary search tree).
